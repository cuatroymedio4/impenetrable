            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group login-form-gruop">
                        <label for="idslider_home" class="cols-sm-2 control-label fw-bold">ID:  <?= h($slider_home->idslider_home)?></label>
                    </div>


                    <div class="form-group login-form-gruop">
                        <label for="title" class="cols-sm-2 control-label fw-bold">Título: </label>
                        <?= $this->Form->input('titulo', ['class' => 'form-control',
                    ...
                    <div class="form-group login-form-gruop">
                        <?= $this->Html->image(h($slider_home->photo), ['pathPrefix' => '/img/slider/', 'class' => 'img-thumbnail',
                            'style' => ['width: 100%']]); ?>
                    </div>
