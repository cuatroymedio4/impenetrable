(L.Control.Sidebar = L.Control.extend({
    ...
    initialize: function (t, e) {
        return (
            "string" == typeof t && (console.warn("this syntax is deprecated. please use L.control.sidebar({ container }) now"), (t = { container: t })),
            "object" == typeof t && t.id && (console.warn("this syntax is deprecated. please use L.control.sidebar({ container }) now"), (t.container = t.id)),
            (this._tabitems = []),
            (this._panes = []),
            (this._closeButtons = []),
            L.setOptions(this, t),
    ...
    onAdd: function (t) {
        var e, i, s, o, n;
        for (
            (n = (n = this._container) || (this._container || "string" == typeof this.options.container ? L.DomUtil.get(this.options.container) : this.options.container)) ||
                ((n = L.DomUtil.create("div", "leaflet-sidebar collapsed")), "string" == typeof this.options.container && (n.id = this.options.container)),
                ...
                null === this._tabContainerTop && ((o = L.DomUtil.create("div", "leaflet-sidebar-tabs", n)).setAttribute("role", "tablist"), (this._tabContainerTop = L.DomUtil.create("ul", "", o))),
                null === this._tabContainerBottom && ((o = this._tabContainerTop.parentNode), (this._tabContainerBottom = L.DomUtil.create("ul", "", o))),
                e = 0;
            e < this._tabContainerTop.children.length;
            e++
        )
            ((i = this._tabContainerTop.children[e])._sidebar = this), (i._id = i.querySelector("a").hash.slice(1)), this._tabitems.push(i);
        ...
        return (
            ...
            t.pane &&
                ("string" == typeof t.pane
                    ? ((e = L.DomUtil.create("DIV", "leaflet-sidebar-pane", this._paneContainer)),
                      (n = ""),
                      t.title && (n += '<h1 class="leaflet-sidebar-header">' + t.title),
                      this.options.closeButton && (n += '<span class="leaflet-sidebar-close"><i class="fa fa-caret-' + this.options.position + '"></i></span>'),
                      t.title && (n += "</h1>"),
                      (e.innerHTML = n + t.pane))
                    : ((e = t.pane), this._paneContainer.appendChild(e)),
                (e.id = t.id),
                this._panes.push(e),
                (o = e.querySelectorAll(".leaflet-sidebar-close")).length && (this._closeButtons.push(o[o.length - 1]), this._closeClick(o[o.length - 1], "on"))),
            this._tabClick(i, "on"),
            this
        );
    },
    ...
    onTabClick: function (t) {
        L.DomUtil.hasClass(this, "active")
            ...
            : L.DomUtil.hasClass(this, "disabled") ||
              ("string" == typeof this._button ? (window.location.href = this._button) : "function" == typeof this._button ? this._button(t) : this._sidebar.open(this.querySelector("a").hash.slice(1)));
    },
    _tabClick: function (t, e) {
        var i = t.querySelector("a");
        i.hasAttribute("href") &&
            "#" === i.getAttribute("href")[0] &&
            ("on" === e ? L.DomEvent.on(t.querySelector("a"), "click", L.DomEvent.preventDefault, t).on(t.querySelector("a"), "click", this.onTabClick, t) : L.DomEvent.off(t.querySelector("a"), "click", this.onTabClick, t));
    },
    ...
    _panMap: function (t) {
        ...
        (("open" === t && "left" === this.options.position) || ("close" === t && "right" === this.options.position)) && (e *= -1), this._map.panBy([e, 0], { duration: 0.5 });
    },
})),
